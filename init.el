...
;;    ido-work-directory-list '("~/" "~/programming" "~/writing" "~/math")
;;    ido-file-extensions-order '(".hs" ".c" ".cc" ".cpp" ".cabal" ".mk" ".py" ".el" ".sh")
...
;;   (ido-mode 'both)
;;   :hook (ido-minibuffer-setup .
;;                               (lambda () (make-local-variable 'resize-minibuffer-window-max-height)
